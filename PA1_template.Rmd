...
The mean of the total number of steps taken per day is `r mean0`.  
...
The maximum number of steps per day are taken in the interval of `r max`
...
The number of missing values in the data sets is `r missing`
...
The new mean and median is `r mean1` and `r median1` respectively.  
